...
<body id="page-top">
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-primary fixed-top" id="sideNav">
    <a class="navbar-brand js-scroll-trigger" href="#page-top">
      <span class="d-block d-lg-none">José Mateus</span>
      <span class="d-none d-lg-block">
        <img class="img-fluid img-profile rounded-circle mx-auto mb-2" src="<?php bloginfo('template_url'); ?>/assets/img/eu.jpg" alt="">
      </span>
    </a>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link js-scroll-trigger" href="#">Experiências</a>
        </li>
        <li class="nav-item">
